...
const pitchColors = {
  ...
  CH: '#008000', FS: '#4682B4', FO: '#B22222', CS: '#9370DB',
  KN: '#FFFF00', EP: '#A0522D', SV: '#20B2AA'
};
...
async function init() {
  ...
  teamSelect.addEventListener('change', () => {
    ...
    for (let pitcher in pitchData[team]) {
  ...
  pitcherSelect.addEventListener('change', () => {
    ...
    const pitcherData = pitchData[team][pitcher];
